 ...
 * @dev Generates Sunset-specific commitment hashes compatible with the Solidity verifier stack on Conflux eSpace
 *
 * CRITICAL COMPATIBILITY NOTE:
 * This circuit MUST produce identical outputs to the commitment format expected
 * by the Sunset Solidity contracts and Conflux eSpace verifier flow. The hash structure is:
 *
