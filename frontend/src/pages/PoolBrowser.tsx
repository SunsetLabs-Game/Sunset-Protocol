          ...
          <div className="relative group overflow-hidden rounded-[24px] p-[1px] transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/10 w-full">
            ...
            <div className="relative z-10 bg-surface/82 backdrop-blur-xl p-6 sm:p-8 rounded-[23px] w-full h-full flex flex-col gap-6">
              <div className="flex items-center justify-between pb-4 border-b border-border/40">
                ...
                <Badge variant="default" className="text-xs bg-surface-elevated/80 border border-border/50 text-text-display">
                  Fee: 0.30%
                </Badge>
              </div>
              ...
              {poolLoading ? (
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1 p-4 rounded-xl border border-border/45 bg-gradient-to-br from-surface-elevated/90 to-surface/45">
                  ...
                  <div className="flex items-center justify-between rounded-xl border border-border/45 bg-surface-elevated/60 p-4">
                    <span className="text-sm font-semibold tracking-widest uppercase text-text-caption">Status</span>
                    <Badge variant={poolState.liquidity > 0n ? "success" : "default"} className={poolState.liquidity > 0n ? "bg-signal-success/20 text-signal-success border-signal-success/30" : "bg-surface/45 text-text-caption border-border/45"}>
          ...
          {poolState && poolState.liquidity > 0n && (
            <Card className="space-y-4 bg-transparent border-none p-0 mt-8 shadow-none">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-4 rounded-xl border border-border/45 bg-gradient-to-br from-surface-elevated/90 to-surface/45">
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-surface-elevated flex items-center justify-center text-text-display font-medium">
                    1
                  </div>
