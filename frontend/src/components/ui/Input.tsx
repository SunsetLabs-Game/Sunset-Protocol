      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <input
            ...
            id={inputId}
            className={cn(
              "h-12 w-full rounded-lg border bg-surface/55 px-4 text-sm text-text-display placeholder:text-text-disabled transition-colors duration-150",
              "focus:outline-none",
              error
                ? "border-signal-error focus:border-signal-error"
                : "border-border focus:border-text-display",
              suffix && "pr-16",
              className
            )}
            {...props}
